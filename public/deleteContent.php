...
if (isset($_POST["content_id"]) && isset($_POST["category_id"])) {
	...
	$deleteResult = $conn->query("DELETE FROM content WHERE id = '".$_POST["content_id"]."' AND category_id = '".$_POST["category_id"]."'");
	
	$deleteResult = $conn->query("DELETE FROM content_image_link WHERE content_id = '".$_POST["content_id"]."' AND category_id = '".$_POST["category_id"]."'");
	
	$deleteResult = $conn->query("DELETE FROM content_sub_category_link WHERE content_id = '".$_POST["content_id"]."' AND category_id = '".$_POST["category_id"]."'");
