<?php
    ...
    $dataArray = array();
	$result = $conn->query("SELECT *,Concat('".$imgPath."','optimize/',SUBSTRING_INDEX(image_path, '/', -1)) as opt_img FROM main_category_data WHERE type = '".$_POST["type"]."' AND valid_flag=1 AND user_id = '".$_POST["user_id"]."' ORDER BY name ASC");
