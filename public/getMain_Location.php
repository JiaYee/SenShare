...
$sql = "SELECT * FROM main_location WHERE main_category_id = '".$_POST["main_category_id"]."' ORDER BY name";
$result = $conn->query($sql);

	while ($row = $result->fetch_object()) {
	$dataArray[] = array("id" => $row->id, "name" => $row->name, "count" => $result->num_rows);
	}
