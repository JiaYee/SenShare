...
if (isset($_POST["verification_code"])) {
	...
	$verificationState = 0;
	$deleteAction = 0;
	$queryString = "SELECT code, delete_action FROM verification_code WHERE code = '".$_POST["verification_code"]."'";
    ...
    echo json_encode(array("Response" => array("responseCode" => 200, "responseMessage" => "Query result"), "data" => array("status" => $verificationState, "delete_action" => $deleteAction)));
