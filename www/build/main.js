...
var EarthPage = (function () {
    ...
    EarthPage.prototype.listitem = function () {
        ...
        loading.present();
        var user_id = this.ss.readData("user_id");
        this.ss.dataList("user_id=" + user_id + "&type=1&start=0", "getMainCategoryDataByType.php").then(function (response) {
...
var FavePage = (function () {
    ...
    FavePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-fave',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\fave\fave.html"*/'<ion-header>\n\n  <ion-navbar color="darkbule">\n\n      <ion-title>Favorite</ion-title>\n\n\n\n      <a tappable ion-button  clear menuToggle >\n\n        <ion-icon name="menu"></ion-icon>\n\n <!-- <img tappable src="assets/BLS_35.png"  class="logo_head"/> -->\n\n      </a>\n\n\n\n\n\n  </ion-navbar>\n\n   <ion-searchbar *ngIf="showme" (ionInput)="getItems($event)" [showCancelButton]="shouldShowCancel"  (ionCancel)="onCancel($event)">></ion-searchbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content >\n\n\n\n  <div class="img_item" *ngFor="let item of items" [ngStyle]="listimage(item.image_path)" style =" transform: translate3d(0px, 0px, 0px);" (click)="openPage(item)">\n\n\n\n   <div class="bottom_txt">\n\n   <p> {{item.name}} </p>\n\n     </div>\n\n\n\n  </div>\n\n\n\n<ion-fab right bottom>\n\n <button ion-fab color="light" (click)="seachshow()"><ion-icon name="search"></ion-icon></button>\n\n\n\n</ion-fab>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\fave\fave.html"*/
        }),
...
var Servercon = (function () {
    ...
    Servercon.prototype.getMainCategory = function () {
        var _this = this;
        var user_id = this.readData("user_id");
        var param = "user_id=" + user_id;
        return new Promise(function (resolve) {
            _this.http.post(_this.ServerURL + "getMainCategoryData.php", param, _this.options)
                .map(function (res) { return res.json(); })
                .subscribe(function (data) {
                resolve(data);
            });
...
var MorePage = (function () {
    ...
    MorePage.prototype.checkLogin = function () {
    ...
    MorePage.prototype.registerPop = function () {
        var _this = this;
        var alert = this.alertCtrl.create({
            title: 'Register',
            inputs: [
                    ...
                    handler: function (data) {
                        ...
                        _this.ss.dataList("phone=" + data.phone + "&password=" + data.password, "register.php").then(function (response) {
                            ...
                            if (data.User_ID) {
                                ...
                                _this.presentToast("Register Failed");
                            }
                        }).catch(function (Error) {
                            console.log("Connection Error" + Error);
                            loading.dismiss();
                    ...
                    handler: function (data) {
                        ...
                        _this.ss.dataList("phone=" + data.phone + "&password=" + data.password, "login.php").then(function (response) {
                            ...
                            if (data.User_ID) {
                                ...
                                _this.ss.saveData("user_id", data.User_ID);
                                _this.ss.saveData("delete_action", "1");
...
var UpdategalleryPage = (function () {
    ...
    UpdategalleryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-updategallery',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\updategallery\updategallery.html"*/'\n\n<ion-header>\n\n    <ion-navbar color="darkbule">\n\n        <ion-title>Upload Image</ion-title>\n\n        <button ion-button clear menuToggle >\n\n        <img src="assets/head_logo.png"  class="logo_head"/>\n\n        </button>\n\n    </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n    <div>\n\n        <ion-list color="light">\n\n\n\n            <ion-item >\n\n                <div>\n\n                <img [src]="image_path"  (click) ="presentActionSheet()"/>\n\n                </div>\n\n            </ion-item>\n\n\n\n            <ion-item>\n\n                <ion-label floating>Description</ion-label>\n\n                <!--<ion-input type="text" [(ngModel)]="desc"></ion-input>-->\n\n                <ion-textarea rows="3" type="text" [(ngModel)]="desc"></ion-textarea>\n\n            </ion-item>\n\n\n\n        </ion-list>\n\n    </div>\n\n    <button ion-button full color="secondary" (click)="savebanner()">Save</button>\n\n    <button ion-button full color="danger"  (click)="cancel()">Cancel</button>\n\n\n\n</ion-content>'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\updategallery\updategallery.html"*/
        }),
...
var EventPage = (function () {
    ...
    EventPage.prototype.listitem = function () {
        ...
        loading.present();
        var user_id = this.ss.readData("user_id");
        this.ss.dataList("user_id=" + user_id + "&type=2&start=0", "getMainCategoryDataByType.php").then(function (response) {
            _this.items = response;
            _this.items = _this.items.Data;
            _this.backup_items = _this.items;
            loading.dismiss();
    ...
    EventPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-event',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\event\event.html"*/'<ion-header>\n\n  <ion-navbar color="darkbule">\n\n      <ion-title>Location</ion-title>\n\n\n\n      <a tappable ion-button  clear menuToggle >\n\n        <ion-icon name="menu"></ion-icon>\n\n <!-- <img tappable src="assets/BLS_35.png"  class="logo_head"/> -->\n\n      </a>\n\n\n\n\n\n  </ion-navbar>\n\n   <ion-searchbar *ngIf="showme" (ionInput)="getItems($event)" [showCancelButton]="shouldShowCancel"  (ionCancel)="onCancel($event)">></ion-searchbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content >\n\n\n\n  <div class="img_item" *ngFor="let item of items" [ngStyle]="listimage(item.image_path)" style =" transform: translate3d(0px, 0px, 0px);" (click)="openPage(item)">\n\n    <ion-badge *ngIf="item.count"  color ="danger" item-right style="margin:0px; width: 40px;">{{item.count}}</ion-badge>\n\n   <div class="bottom_txt">\n\n   <p> {{item.name}} </p>\n\n     </div>\n\n\n\n  </div>\n\n\n\n<ion-fab right bottom>\n\n\n\n\n\n\n\n<button ion-fab color="light"><ion-icon name="arrow-dropup"></ion-icon></button>\n\n    <ion-fab-list side="top">\n\n       <button ion-fab color="light" (click)="seachshow()"><ion-icon name="search"></ion-icon></button>\n\n       <button ion-fab color="light" [navPush]="addcategorypage"><ion-icon name="add"></ion-icon></button>\n\n    </ion-fab-list>\n\n\n\n\n\n</ion-fab>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\event\event.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["b" /* AlertController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */], __WEBPACK_IMPORTED_MODULE_2__providers_servercon__["a" /* Servercon */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* LoadingController */]])
    ], EventPage);
    return EventPage;
...
var AboutusPage = (function () {
    ...
    AboutusPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-aboutus',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\aboutus\aboutus.html"*/'<ion-header>\n\n  <ion-navbar color="darkbule">\n\n    <a tappable ion-button  clear menuToggle >\n\n      <ion-icon name="menu"></ion-icon>\n\n<!-- <img tappable src="assets/BLS_35.png"  class="logo_head"/> -->\n\n    </a>\n\n\n\n    <ion-title>About Us</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <div class="bg" padding [innerHTML]="htmlinfo"></div>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\aboutus\aboutus.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */],
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\app\app.html"*/'<ion-menu [content]="content" >\n\n  <ion-header >\n\n    <ion-toolbar color="darkcray">\n\n      <div padding>\n\n        <div class="topmenutitle">{{myname}}</div>\n\n     \n\n    </div> \n\n    </ion-toolbar>\n\n   \n\n  </ion-header>\n\n\n\n  <ion-content >\n\n    <ion-list>\n\n <div *ngFor="let p of pages">     \n\n<ion-item  menuClose  (click)="openPage(p)" *ngIf="adminonly(p.adminonly)" >\n\n       <ion-icon *ngIf="p.icon" [name]="p.icon" item-left></ion-icon>\n\n<img *ngIf="p.img" [src]="p.img" item-left width="27px" height="27px" [ngStyle]="mystyle"/>\n\n        {{p.title}}\n\n      </ion-item>\n\n </div>\n\n    </ion-list>\n\n  </ion-content>\n\n\n\n</ion-menu>\n\n\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\app\app.html"*/
        }),
...
var TabtoptenPage = (function () {
    ...
    TabtoptenPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-tabtopten',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\tabtopten\tabtopten.html"*/'\n\n<ion-tabs >\n\n  <ion-tab [root]="page" tabTitle="Home" tabIcon="contact"></ion-tab>\n\n  <ion-tab [root]="page1" tabTitle="About" tabIcon="compass"></ion-tab>\n\n  <ion-tab [root]="page2" tabTitle="Exit" tabIcon="analytics"></ion-tab>\n\n</ion-tabs>\n\n\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\tabtopten\tabtopten.html"*/
        }),
...
var VideoPage = (function () {
    ...
    VideoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-video',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\video\video.html"*/'<!--\n\n  Generated template for the Video page.\n\n\n\n  See http://ionicframework.com/docs/v2/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>video</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\video\video.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */]])
    ], VideoPage);
    return VideoPage;
...
var AddvideoPage = (function () {
    ...
    AddvideoPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-addvideo',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\addvideo\addvideo.html"*/'\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>addvideo</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\addvideo\addvideo.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */]])
    ], AddvideoPage);
    return AddvideoPage;
...
var AddcategoryPage = (function () {
    ...
    AddcategoryPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-addcategory',template:/*ion-inline-start:"C:\Users\131216\Crappy\SenShare\src\pages\addcategory\addcategory.html"*/'\n\n<ion-header>\n\n\n\n  <ion-navbar color="darkbule">\n\n    <ion-title>Add Category</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n<ion-list>\n\n\n\n <ion-item>\n\n    <div>\n\n    <img [src]="image_path"  (click) ="presentActionSheet()"/>\n\n    </div>\n\n  </ion-item>\n\n\n\n  <ion-item>\n\n    <ion-label stacked>Category Name:</ion-label>\n\n    <ion-input type="text" [(ngModel)]="name"></ion-input>\n\n  </ion-item>\n\n\n\n<ion-item>\n\n    <ion-label>Type</ion-label>\n\n    <ion-select [(ngModel)]="type">\n\n     <ion-option value="1">Earth</ion-option>\n\n      <ion-option value="2">Location</ion-option>\n\n    </ion-select>\n\n  </ion-item>\n\n\n\n  <ion-item>\n\n    <ion-label stacked>Top</ion-label>\n\n    <ion-input  type="number" step="any" name="topRate" [(ngModel)]="rate" min="1"\n\n               max="20"></ion-input>\n\n  </ion-item>\n\n\n\n</ion-list>\n\n\n\n<button ion-button full color="secondary" (click)="save()">Save</button>\n\n <button ion-button full color="danger"  (click)="cancel()">Cancel</button>\n\n\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\131216\Crappy\SenShare\src\pages\addcategory\addcategory.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* Platform */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* NavParams */],
